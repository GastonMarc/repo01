...
function historial_renderModalCargaMasiva($object_id)
{
    ...
    echo "<p>Una carga masiva se puede hacer de dos maneras: </p>";
    echo "<p>  1.Generar en el <strong>BLOQUE DE CARGA</strong> un renglón por cada evento que querés agregar </p>";
    echo "<p>  2.Subir un archivo <strong>\"carga-masiva.txt\"</strong>similar al que puedes bajar con \"Descargar Plantilla\" </p>";
    echo "<p> En cualquiera de los casos, debes generar un renglón por cada evento, con cada columna separada por <strong>;</strong></p>";
    echo "<p> El campo <strong>Evento</strong> (ID del Evento )  déjalo en blanco, el sistema lo generará automáticamente.</p>";
    echo "<p> El resto de los campos los puedes completar o dejar en blanco, siempre que los separes por <strong>;</strong></p>";
    echo "<p> El campo <strong>\"Adjuntos\"</strong> déjalo en blanco</p>";
    ...
    echo "\n";
    echo "RESTRICCIONES:\n";
    echo "- Evento:        Dejar en blanco y poner  ;\n";
    echo "- Equipo:        Debe ser el nombre exacto del equipo en RackTables \n";
    echo "-                No tiene que ser exactamente este equipo, puede ser cualquiera (max 255 caract.)\n";
    ...
    echo "- Descripción:   max 400 caracteres\n";
    ...
    echo "<h3>Ejemplo</h3>";
    echo "<pre>";
    echo ";S1F1R01U41;08/03/2026 09:21;dcifuentes;Mudanza;Avisamos al NOC que comienza la mudanza;En curso;Observaciones-1;;OT-123678;\n";
    echo ";S1F1R01U41;08/03/2026 10:21;dcifuentes;Mudanza;Se procede a apagar el servidor;Finalizado;Cerrar la OT-122133a;;OT-123678;\n";
    echo ";S1F1R01U41;08/03/2026 12:34;dcifuentes;Mudanza;Equipo listo para mudanza;En curso;Avisar a Tapha;;OT-123678;\n";
    echo ";S1F4R01U05;10/02/2026 15:13;ndemary;Mantenimiento;Reemplazo de memoria;;OT-666222;\n";
    echo "</pre>";

    echo "<h3>BLOQUE DE CARGA</h3>";
